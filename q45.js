...
function carsummry(manufacturer, model) {
    var extrinfos = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        extrinfos[_i - 2] = arguments[_i];
    }
...
var carr1 = carsummry("Suzuki", "Jiminy", ["color", "Jungle Green"], ["year", 2023], ["sunroof", true]);
