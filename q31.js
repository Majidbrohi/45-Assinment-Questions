...
var userNames = ["admin", "Malik-e-Ashter", "Zarrar Haider", " Hafi Ali", "Sultan Teepo"];
userNames.forEach(function (adms) {
    if (adms === "admin") {
        console.log(" Hello  ".concat(adms, ", would you like to see a status report?"));
    }
    else {
        console.log(" Hello ".concat(adms, ", thank you for logging in again"));
    }
});
