...
let userNames1 : string[] = ["Anziq", "Sultan Teepo" , "A.Raheem" , "Ab.Kareem" , "Zarrar Haider" ];

//? Here I made another array named "usernames1" .
let newUsers : string[] = ["admin" , "Malik-e-Ashter" , "Zarrar Haider" , " Hafi Ali" , "Sultan Teepo" ];
...
newUsers.forEach(user => {
 ...
 if(userNames1.map(u => u.toLocaleLowerCase()).indexOf(user.toLocaleLowerCase())){
    console.log(`Sorry! ${user} Hase been already used.`)
 }else {
