...
var guestList111 = ["Commander Khoala bint e asfar", "Zarrar Haider", " Hafi Ali", "Sultan Teepo"];
...
guestList111.forEach(function (guest) { return console.log("Dear ".concat(guest, " You're invited to the dinner")); });
